...
public class ListUpdateTest {
    public static void main(String[] args) {
        ...
        // Create an empty observable list with a callback to extract
        // the observables values for each element of the list
    ...
    public static void onChanged(
        ...
        while(change.next()){
            if(change.wasUpdated()){
                ...
                System.out.println("Updated elements: " + updateElementsList);
            }
        }
    }
}
